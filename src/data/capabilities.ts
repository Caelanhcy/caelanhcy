...
export const CAPABILITIES: Capability[] = [
  {
    ...
    thesisZh:
      '关于设计实际为何而做 —— 以及它如何在抽象、物理、化学与人这四重领域上同时运作。',
    essay:
  ...
  },
  {
    ...
    thesisZh:
      '文化、隐性期待、习惯性概念 —— 每个人凭着、却没人写下来的那一层运营底色。',
    essay:
  ...
  },
  {
    ...
    thesisZh:
      '世界正在我们脚下移动 —— 行业如何转向，我们为何需要现在需要的，又该如何上手。',
    essay:
    ...
    artifacts: [
      ...
      },
      {
        ...
        detail:
          'November and December 2024 at DIER. 100–500 units sold within 30 days of launch. 15–30% improvement in launch success rates by Q1 2025.',
      },
    ],
  ...
  },
  {
    ...
    thesisZh:
      '规则为何承重 —— 为什么先把"成功"写下来，比急着选一条路更要紧。',
    essay:
  ...
  },
  {
    ...
    thesisZh:
      '感受与挑选，是我们留给自己的东西。个性对每一个人都成立，对群体却不成立。',
    essay:
